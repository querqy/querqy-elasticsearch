...
public class NodesReloadRewriteChainResponse extends BaseNodesResponse<NodesReloadRewriteChainResponse.NodeResponse>
        implements ToXContentObject {


    public NodesReloadRewriteChainResponse() { }

    public NodesReloadRewriteChainResponse(final ClusterName clusterName, final List<NodeResponse> responses,
                                           final List<FailedNodeException> failures) {
        super(clusterName, responses, failures);
    }

    public NodesReloadRewriteChainResponse(final StreamInput in) throws IOException {
        super();
        readFrom(in);
    }
    ...
    protected List<NodeResponse> readNodesFrom(final StreamInput in) throws IOException {
        return in.readList(NodesReloadRewriteChainResponse.NodeResponse::readNodeResponse);
        }
    ...
    public static class NodeResponse extends BaseNodeResponse {
        ...
        public boolean equals(final Object o) {
            ...
            final NodesReloadRewriteChainResponse.NodeResponse that = (NodesReloadRewriteChainResponse.NodeResponse) o;
        ...
        static NodesReloadRewriteChainResponse.NodeResponse readNodeResponse(final StreamInput in) throws IOException {
            return new NodesReloadRewriteChainResponse.NodeResponse(in);
        }
